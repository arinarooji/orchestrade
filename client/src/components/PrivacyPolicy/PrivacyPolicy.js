...
const PrivacyPolicy = () => {
  return (
    <div>
      ...
      <h4>Last updated: February 18, 2018</h4>

      <p>
        Orchestrade ("us", "we", or "our") operates the
        www.Orchestrade.com website (the "Service"). This page informs you
        of our policies regarding the collection, use and disclosure of Personal
        Information when you use our Service. We will not use or share your
        information with anyone except as described in this Privacy Policy.
        Privacy Policy for Orchestrade based on the Privacy Policy example
        from TermsFeed. We use your Personal Information for providing and
      ...
      <p>
        ...
        Cookies Cookies are files with small amount of data, which may include
        an anonymous unique identifier. Cookies are sent to your browser from a
        web site and stored on your computer's hard drive. We use "cookies" to
      ...
      <p>
        ...
        or use it for any other purpose. Security The security of your Personal
        ...
        Links To Other Sites Our Service may contain links to other sites that
      ...
      <p>
        ...
        you are aware that your Children has provided us with Personal
        Information, please contact us. If we discover that a Children under 13
        has provided us with Personal Information, we will delete such
        information from our servers immediately. Changes To This Privacy Policy
